...
class MyTestCase(unittest.TestCase):
    ...
    def test_1_successive_outlier_Malik(self):
        ...
        self.assertEqual(hrv.clean_outlier_v1(RrIntervals=rri_list, method="Malik"),
    ...
    def test_1_successive_outlier_Kamath(self):
        ...
        self.assertEqual(hrv.clean_outlier_v1(RrIntervals=rri_list, method="Kamath"),
    ...
    def test_1_successive_outlier_Karlsson(self):
        ...
        self.assertEqual(hrv.clean_outlier_v1(RrIntervals=rri_list, method="Karlsson"),
    ...
    def test_1_successive_outlier_mean_last_9_elt(self):
        ...
        self.assertEqual((hrv.clean_outlier_v1(RrIntervals=rri_list, method="mean_last9")),
